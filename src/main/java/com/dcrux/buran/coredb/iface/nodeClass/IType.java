...
public interface IType extends Serializable {
  ...
  /**
   * Returns the sorter implementation if the given sorter-ref is supported. Returns <code>null</code> if the sorter-ref is not supported.
   *
   * @param sorterRef
  ...
  /**
   * Sets data.  The implementation is allowed to throw an exception if not data setter is not supported (see {@link #supports(IDataSetter)}.
   *
   * @param dataSetter
   * @param currentValue The current value. The implementation is allowed to modify the reference target.
  ...
  /**
   * Gets data. The implementation is allowed to throw an exception if not data getter is not supported (see {@link #supports(IDataGetter)}.
   *
   * @param dataGetter
   * @param value      The implementation MUST NOT modify the value.
